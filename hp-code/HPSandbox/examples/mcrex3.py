...
import sys
sys.path.append("/home/charles/stonybrook/hp-code/HPSandbox/")
...
def attemptswap(replicas,swaps,viableswaps): 
    ...
    delfactor = ((old_div(1,(replicas[j].mc.k*replicas[j].mc.temp))) - (old_div(1,(replicas[j].mc.k*replicas[i].mc.temp))))
