...
class Monty(object):
    ...
    def __init__(self,config,temp,chain):
        ...
        self.g = random.Random(config.randseed)               # NOTE:  random.Random is an object that needs an integer seed for initialization
        ...
        self.k = config.k				      # Boltzmann's constant (both of these are copies from Config() )
...
"""
    ...
    def metropolis(self,replica):
        ...
        boltzfactor = math.exp(old_div((thisenergy - self.lastenergy),(self.k*self.temp)))
